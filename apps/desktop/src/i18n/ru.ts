...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      designV2Title: 'Интерфейс в стиле Codex',
      designV2Desc: 'Предпросмотр обновлённого интерфейса: сгруппированная панель, диалог с пузырями и текстом, переработанный ввод. Выключено — текущий дизайн.',
