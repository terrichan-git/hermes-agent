...
import { WIDGET_TINT_SHELL_CLASS } from '@/components/chat/widget-shell'
...
const CLARIFY_SHELL_CLASS = `${WIDGET_TINT_SHELL_CLASS} text-[length:var(--conversation-text-font-size)] text-(--ui-text-primary)`
